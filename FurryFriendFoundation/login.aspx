<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="FurryFriendFoundation.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="log">
        <div class="log-content">
            ...
            <br />
            <div class="btn1">
                <asp:Button ID="button" Text="Log in" runat="server" CssClass="btn btn-warning" OnClick="button_Click" />
