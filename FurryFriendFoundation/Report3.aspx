<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="Report3.aspx.cs" Inherits="FurryFriendFoundation.WebForm22" %>
     ...
     <div class="bg">
        <div class="content-wrapper">
            <div class="centered-content">
                <div align="center" style="font-size:30px">Animla For Adoption Report</div>
                <div align="center">
                    <asp:Button ID="Button1" runat="server" Text="Load Report" Font-Size="Large" BackColor="#FF9933" OnClick="Button1_Click" />
                    <br />
                    <div class="report-viewer-container">
                        <asp:ScriptManager runat="server" />
                        <rsweb:reportviewer ID="ReportViewer2" runat="server" CssClass="report-viewer" Height="50%" Width="80%"></rsweb:reportviewer>
                    </div>
                </div>
            </div>
        </div>
